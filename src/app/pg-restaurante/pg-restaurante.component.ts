...
@Component({
  selector: 'app-pg-restaurante',
  templateUrl: './pg-restaurante.component.html',
  styleUrls: ['./pg-restaurante.component.scss']
})
export class PgRestauranteComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PgRestauranteComponent>,
